    ...
    req.on('end',function(){    
        async.series([
            function(next){
                ...
                request.get('http://api.rottentomatoes.com/api/public/v1.0/movies.json?q='+data.incoming.text+
            ...
            function(next){
                ...
                request.get('http://api.rottentomatoes.com/api/public/v1.0/movies/'+data.search.movies[0].id+
                    ...
                    if(r){
                        ...
                        data.out.channel=data.inc.channel;
            ...
            function(next){
                data.error&&(data.out.text=data.errmsg,data.out.channel=data.inc.channel,data.out.username='Error');
